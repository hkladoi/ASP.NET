...
{
    public partial class hkladoi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    LinkImage = table.Column<byte[]>(type: "image", nullable: false),
                    LinkImage1 = table.Column<byte[]>(type: "image", nullable: true),
                    LinkImage2 = table.Column<byte[]>(type: "image", nullable: true),
                    LinkImage3 = table.Column<byte[]>(type: "image", nullable: true),
                    LinkImage4 = table.Column<byte[]>(type: "image", nullable: true)
                },
                constraints: table =>
                {
